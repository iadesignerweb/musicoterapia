...
let socket = null;
let SOCKET_ENDPOINT = 'https://compliance-citizen-considers-dos.trycloudflare.com/'; // preenchido via Settings (campo 'Endpoint Socket')
/* ============================ */
...
function seedData() {
  ...
  if (!localStorage.getItem(STORAGE_KEYS.settings)) {
    const settings = { socketEndpoint: SOCKET_ENDPOINT, adminPass:'wifire2025' };
